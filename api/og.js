...
const ARTICLES = [
  ...
  { id: 37, title: 'GTD (Getting Things Done): Zbraz mendjen për të menduar', excerpt: '"Mendja duhet të jetë si ujë", pa barrë detyrave të paplasifikuara. GTD e zbraz mendjen për të menduar, jo për të mbajtur mend.', image: 'https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?auto=format&fit=crop&w=1200&q=80' },
  ...
  { id: 40, title: 'Sfida 30-ditore kognitive: Dual N-Back, meditim dhe lexim aktiv', excerpt: 'Kombinim i tre teknikave me bazë shkencore: 55 minuta/ditë për 30 ditë. Protokoll i plotë me matje para dhe pas.', image: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=1200&q=80' },
  ...
  { id: 42, title: 'Protokolli 8-javësh i gjumit optimal (CBT-I vetë-zbatim)', excerpt: 'CBT-I adaptuar si protokoll pa terapis. 8 javë, 5 strategji klinike të provuara. 76% efektivitet i raportuar pa ilaçe.', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=1200&q=80' },
  ...
  { id: 45, title: 'Si një startup zbatoi neuroshkencën në kulturën e punës', excerpt: 'Eliminuan mbledhjet e mëngjesit, zbatuan deep work blocks dhe No-Meeting Fridays. Produktiviteti u rrit 28% brenda 3 muajsh.', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1200&q=80' },
  { id: 46, title: '10 kurse online falas nga Harvard, MIT dhe Stanford', excerpt: 'Harvard, MIT, Stanford dhe Yale ofrojnë kurse falas mbi psikologjinë, neuroshkencën dhe produktivitetin. Lista e kuruar me kujdes.', image: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&q=80' },
  { id: 47, title: '7 studime themelore që riformuan psikologjinë moderne', excerpt: 'Nga eksperimenti i Milgram-it te Attachment Theory: hulumtimet që çdo person i informuar duhet t\'i njohë.', image: 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?auto=format&fit=crop&w=1200&q=80' },
  ...
  { id: 54, title: 'Arti i diskutimit shkencor: Si të debatoni pa konflikte bosh', excerpt: 'Shumica e debateve online janë emocion, jo arsye. Kjo udhëzues praktike të mëson si të diskutoni ideat me integritet intelektual.', image: 'https://images.unsplash.com/photo-1507537297879-f86f8e5faffb?auto=format&fit=crop&w=1200&q=80' },
...
const SITE_IMAGE = 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=80'
