...
export const SITE_TEXTS = [
  ...
  { id: 'hero-subtitle',    section: 'Landing › Hero',     label: 'Nëntitull',              default: 'NeuroSphera bashkon psikologji klinike, AI dhe gjurmim të humorit — mbështetje e vërtetë mendore, çdo ditë, kudo.',                                defaultEn: 'NeuroSphera combines clinical psychology, AI and mood tracking — real mental support, every day, in Albanian.' },
  ...
  { id: 'diff-badge',       section: 'Landing › Pse NeuroSphera', label: 'Badge tekst',        default: 'Pse NeuroSphera',                                                                                                                              defaultEn: 'Why NeuroSphera' },
  { id: 'diff-h2-line1',   section: 'Landing › Pse NeuroSphera', label: 'Titull rresht 1',    default: 'Jo vetëm',                                                                                                                                            defaultEn: 'Not just' },
  { id: 'diff-h2-line2',   section: 'Landing › Pse NeuroSphera', label: 'Titull rresht 2 (ngjyrë)', default: 'përmbajtje —',                                                                                                                                  defaultEn: 'content —' },
  { id: 'diff-h2-line3',   section: 'Landing › Pse NeuroSphera', label: 'Titull rresht 3',    default: 'por transformim',                                                                                                                                      defaultEn: 'but transformation' },
  { id: 'diff-h2',          section: 'Landing › Pse NeuroSphera', label: 'Titulli seksionit', default: 'Jo vetëm përmbajtje — por transformim',                                                                                                              defaultEn: 'Not just content — but transformation' },
  { id: 'diff-sub',         section: 'Landing › Pse NeuroSphera', label: 'Nëntitulli',       default: 'Portalet tjera ofrojnë artikuj. NeuroSphera ofron një sistem të plotë — nga teoria te praktika, nga leximi te zakoni i qëndrueshëm.',                  defaultEn: 'Other portals offer articles. NeuroSphera offers a complete system — from theory to practice, from reading to lasting habit.' },
  { id: 'diff-cta',         section: 'Landing › Pse NeuroSphera', label: 'Buton CTA',        default: 'Fillo pa kushte',                                                                                                                                     defaultEn: 'Start with no strings attached' },
  { id: 'diff-item-0-title',section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 1 titulli', default: 'Neural Learning Paths',                                                                                                                            defaultEn: 'Neural Learning Paths' },
  { id: 'diff-item-0-desc', section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 1 description', default: 'Rrugë mësimi të personalizuara bazuar në parimet e neuroplasticitetit — jo kurse lineare, por sisteme adaptive.',                              defaultEn: 'Personalized learning paths based on neuroplasticity principles — not linear courses, but adaptive systems.' },
  { id: 'diff-item-1-title',section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 2 titulli', default: 'Interactive Labs',                                                                                                                                 defaultEn: 'Interactive Labs' },
  { id: 'diff-item-1-desc', section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 2 description', default: 'Ushtrime dhe eksperimente të vërteta — jo vetëm lexim, por veprim i dokumentuar me rezultate të matshme.',                                     defaultEn: 'Real exercises and experiments — not just reading, but documented action with measurable results.' },
  { id: 'diff-item-2-title',section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 3 titulli', default: 'Spaced Repetition Engine',                                                                                                                         defaultEn: 'Spaced Repetition Engine' },
  { id: 'diff-item-2-desc', section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 3 description', default: 'Sistemi ynë i brendshëm i kujtesës siguron që çfarë mëson sot, e mban edhe pas 6 muajsh.',                                                    defaultEn: 'Our internal memory system ensures what you learn today, you retain even after 6 months.' },
  { id: 'diff-item-3-title',section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 4 titulli', default: 'Community-Powered Learning',                                                                                                                       defaultEn: 'Community-Powered Learning' },
  { id: 'diff-item-3-desc', section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 4 description', default: 'Grupe studimi, sfida kolektive dhe mentorë realë — sepse mësohet më mirë bashkë.',                                                             defaultEn: 'Study groups, collective challenges and real mentors — because learning together works better.' },
  { id: 'diff-item-4-title',section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 5 titulli', default: 'AI Tutor Personal',                                                                                                                                defaultEn: 'Personal AI Tutor' },
  { id: 'diff-item-4-desc', section: 'Landing › Pse NeuroSphera', label: 'Avantazhi 5 description', default: 'Rekomandime të personalizuara bazuar në interesat, historikun dhe qëllimet e çdo anëtari.',                                                   defaultEn: 'Personalized recommendations based on the interests, history and goals of each member.' },
  ...
  { id: 'testimonial-0-text',   section: 'Landing › Dëshmi',    label: 'Dëshmi 1 teksti',         default: 'NeuroSphera ndryshoi mënyrën time të studimit. Rezultatet u dyfishuan brenda 3 javësh me teknikat e tyre të bazuara në neuroshkencë.',            defaultEn: 'NeuroSphera changed the way I study. Results doubled within 3 weeks with their neuroscience-based techniques.' },
  ...
  { id: 'testimonial-1-text',   section: 'Landing › Dëshmi',    label: 'Dëshmi 2 teksti',         default: 'Si entrepreneur, "Deep Work" dhe sistemet e fokusit nga NeuroSphera u bënë fondamenti i çdo dite produktive. Jashtzakonisht praktike.',          defaultEn: 'As an entrepreneur, "Deep Work" and focus systems from NeuroSphera became the foundation of every productive day. Incredibly practical.' },
  ...
  { id: 'cta-sub',          section: 'Landing › CTA',       label: 'CTA nëntitulli',         default: 'Mbi 25,000 njerëz tashmë po zhvillojnë mendjen e tyre me NeuroSphera. Sot mund të fillosh edhe ti.',                                                  defaultEn: 'Over 25,000 people are already developing their minds with NeuroSphera. Today you can start too.' },
  ...
  // ── Landing › Footer ──────────────────────────────────────────────────────
  { id: 'footer-brand',     section: 'Landing › Footer',    label: 'Brand emri',             default: 'NeuroSphera',                                                                                                                                         defaultEn: 'NeuroSphera' },
  { id: 'footer-tagline',   section: 'Landing › Footer',    label: 'Footer tagline',         default: 'Platforma pioniere e zhvillimit të mendjes bazuar në neuroshkencë. Mëso si funksionon truri yt.',                                             defaultEn: 'The first Albanian platform for mind development based on neuroscience. Learn how your brain works.' },
  { id: 'footer-copyright', section: 'Landing › Footer',    label: 'Copyright',              default: 'NeuroSphera. Të gjitha të drejtat e rezervuara.',                                                                                                     defaultEn: 'NeuroSphera. All rights reserved.' },

  // ── Landing › Nav ─────────────────────────────────────────────────────────
  { id: 'nav-brand',        section: 'Landing › Nav',       label: 'Brand emri',             default: 'NeuroSphera',                                                                                                                                         defaultEn: 'NeuroSphera' },
  ...
  { id: 'carousel-slide-0-desc',  section: 'Carousel Shërbimeve', label: 'Slide 1 description', default: 'Bisedoni me asistentin tonë AI të trajnuar në psikologji klinike. Mbështetje 24/7, pa ndalesë.',                                             defaultEn: 'Chat with our AI assistant trained in clinical psychology. Support 24/7 in your language.' },
