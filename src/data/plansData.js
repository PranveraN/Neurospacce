...
export const PLANS = {
  ...
  premium: {
    ...
    features: [
      ...
      { label: 'Hyrje me zë për asistentin AI',                         included: true },
    ],
  },
...
export const UPGRADE_MESSAGES = {
  bookAppointment: {
    title: 'Rezervimet janë pjesë e planit Pro',
    desc:  'Rezervo takim me psikolog të verifikuar — sesione 45–60 min, konfidenciale dhe profesionale. E disponueshme me planin Pro.',
    feature: 'Rezervim takimesh',
    tone: 'warm',
    cta: 'Zbulo Pro',
  },
  askPsychologist: {
    title: 'Konsultimet janë pjesë e planit Pro',
    desc:  'Dërgo pyetje private te psikologu dhe merr përgjigje brenda 24 orësh. Me Pro ke 15 pyetje në muaj.',
    feature: 'Pyetje private te psikologu',
    tone: 'warm',
  },
  privateQuestions: {
    title: 'Pyetjet private janë Pro',
    desc:  'Me Pro ke 15 pyetje private çdo muaj — deri 3 në ditë. Psikologu i verifikuar përgjigjet brenda 24 orësh.',
    feature: '15 pyetje/muaj · brenda 24h',
    tone: 'warm',
  },
  miniSessions: {
    title: 'Sesionet online janë Pro',
    desc:  '2 sesione 15-minutëshe me psikolog çdo muaj — me video, plotësisht konfidenciale dhe të sigurta.',
    feature: '2 sesione online/muaj',
    tone: 'warm',
  },
  aiVoice: {
    title: 'Hyrja me zë — Premium',
    desc:  'Fol drejtpërdrejt me asistentin AI — e disponueshme me planin Premium.',
    feature: 'Zë + AI',
    tone: 'soft',
  },
  journalAI: {
    title: 'Reflektim AI — Pro',
    desc:  'Zbulo emocionet, mendimet dhe merr sugjerime nga AI mbi shkrimin tënd. E disponueshme me planin Pro.',
    feature: 'Reflektim AI i personalizuar',
    tone: 'warm',
    cta: 'Zbulo Pro',
  },
  journalUnlimited: {
    title: 'Histori e plotë — Pro',
    desc:  'Me planin Free shikon 5 hyrjet e fundit. Me Pro ke akses të plotë, reflektim AI dhe eksport të të dhënave.',
    feature: 'Ditar pa kufi + AI',
    tone: 'warm',
    cta: 'Zbulo Pro',
  },
}
