...
export const PERSONALITY_TEST = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { label: 'Pa plan — veproj sipas momentit', score: 1 },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Mesatarisht — i/e vlerësoj por nuk i/e praktikoj', score: 2 },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Mjaft mirë — socializimi më energjizon', score: 3 },
    ...
    },
    {
      ...
      options: [
        { label: 'Spontanisht — veproj sipas asaj që ndodh', score: 1 },
  ...
  profiles: [
    ...
    },
    {
      ...
      desc: 'Ti je personi mbi të cilin të tjerët mbështeten. I/E ndërgjegjshëm/e dhe e besueshme, i qasesh çdo detyre me vëmendje dhe disiplinë. Njerëzit e ditur e dinë se kur diçka kalon nëpër duart e tua, do të bëhet saktë dhe në kohë. Ke aftësinë e rrallë të transformosh kaos në rend — dhe kjo vleri nuk ka çmim.',
    ...
    },
    {
      ...
      desc: 'Ti je zemra e çdo grupi. Njerëzit tërhiqen nga ngrohtësia jote dhe aftësia jote për t\'i bërë të gjithë të ndihen të parë dhe të vlerësuar. Ke inteligjencë emocionale të lartë dhe di instinktivisht si të ndërtosh ura mes njerëzve. Talenti yt i vërtetë qëndron në krijimin e lidhjeve që zgjasin.',
    ...
    },
    {
      ...
      desc: 'Ti ndjen botën shumë thellë. Ndjeshmëria jote e lartë është edhe forca edhe sfida jote — të jep aftësinë të kuptosh nuancat emocionale që të tjerët i humbin, por edhe të ndjesh presionin e situatave me intensitet të madh. Analizon, reflekton dhe kurrë nuk e pranon gjërat sipërfaqësisht.',
    ...
    },
    {
      ...
      color: '#d97706',
      condition: () => true,
      desc: 'Ti je shembulli i ekuilibrit autentik. S\'ke tipare ekstreme — dhe kjo është forcë e madhe, jo mungesë identiteti. Adaptohesh me lehtësi në role të ndryshme, sillesh mirë si në mjedise sociale ashtu edhe në vetmi, dhe njerëzit e ndiejnë stabilitetin tënd si diçka të rrallë dhe të çmuar.',
...
export const MOOD_TEST = {
  ...
  profiles: [
    ...
    },
    {
      ...
      desc: 'Po përjeton njëkohësisht emocione pozitive dhe negative të forta — kjo quhet ambivalencë emocionale. Ndodh shpesh në momente tranzicioni, vendimesh të rëndësishme ose ndryshimesh të mëdha. Nuk është diçka e keqe — tregon thellësi emocionale. Lejo veten të trajtosh të dyja palët pa u gjykuar.',
    },
    {
      id: 'tense',
...
export const COGNITIVE_TEST = {
  ...
  profiles: [
    ...
    },
    {
      ...
      color: '#7c3aed',
      minScore: 3,
      desc: 'Ke ekuilibër të mirë mes mendimit logjik dhe intuitiv. Arrin të ndjekësh arsyetimin formal kur të nevojitet, por edhe t\'i besosh gjykimit të brendshëm. Ky kombinim të bën efektiv në situata të ndryshme.',
    },
    {
      id: 'intuitive',
      ...
      color: '#f59e0b',
      minScore: 2,
      desc: 'Mendja jote funksionon më mirë nëpërmjet intuitës dhe njohjes së modeleve holistike. Ndonjëherë arsyetimi formal mund të duket i kufizuar — por intuita e kultivuar është fuqi e jashtëzakonshme. Vazhdimi i praktikës logjike do të forcojë edhe më tej mendimin tënd.',
    },
    {
      id: 'developing',
