...
export const IQ_TEST = {
  id:            'iq',
  title:         'Testi IQ',
  subtitle:      'Kuofienti i Inteligjencës',
  emoji:         '🧠',
  color:         '#4f46e5',
  ...
  iq_classification: [
    ...
    },
    {
      min: 115, max: 129,
      label: 'Mbi Mesatar',
      desc:  'Inteligjencë mbi normën. Kapen koncepte komplekse me lehtësi dhe arsyetohet me saktësi e shpejtësi.',
      color: '#2563eb',
    },
    {
      min: 85, max: 114,
      label: 'Mesatar',
      desc:  'Nivel tipik i inteligjencës. Shumica e njerëzve (68%) bien në këtë interval. Aftësi të plota problemzgjidhëse.',
      color: '#059669',
    },
    {
      min: 60, max: 84,
  ...
  questions: [
    // ── PATTERN RECOGNITION (4 q) ────────────────────────────────────────────
    {
      ...
      text: 'Cili numër plotëson vargün: 2, 4, 8, 16, __?',
      options: ['24', '32', '30', '20'],
      correct: '32',
    ...
    },
    {
      ...
      options: ['Q', 'S', 'R', 'T'],
      correct: 'S',
      explanation: 'Ndryshimet pozicionale rriten me 1: A+3=D, D+4=H, H+5=M, M+6=S.',
    },
    {
      id: 'iq_p3', domain: 'pattern', difficulty: 2,
      text: 'Cili numër plotëson vargün Fibonacci: 1, 1, 2, 3, 5, 8, __?',
      options: ['11', '13', '12', '10'],
      correct: '13',
      explanation: 'Çdo term është shumë e dy termave paraardhës: 5+8=13.',
    },
    {
      id: 'iq_p4', domain: 'pattern', difficulty: 3,
      text: 'Cili numër mungon: 3, 6, 11, 18, 27, __?',
      options: ['36', '38', '40', '35'],
      correct: '38',
      explanation: 'Ndryshimet rriten me 2: +3, +5, +7, +9, +11. Pra 27+11=38.',
    },
    ...
    // ── LOGICAL DEDUCTION (4 q) ──────────────────────────────────────────────
    {
      ...
      options: [
        ...
        'Macet dhe fluturën janë identike',
      ],
    ...
    },
    {
      ...
      text: 'Maria > Ana. Ana > Gerta. Blerti > Maria. Kush është personi i dytë më i gjatë?',
    ...
    },
    {
      ...
      text: 'Nëse shi → qëndroj brenda. Nëse jo shi → shëtis. Sot nuk shëtita. Çfarë ndodhi?',
      options: ['Doli shi', 'Nuk doli shi', 'Ndoshta doli shi', 'Asgjë nuk mund të thuhet'],
      correct: 'Doli shi',
      explanation: 'Kontrapozitiv: "nuk shëtita" → "doli shi" (sipas premisës dyore të dhënë).',
    },
    {
      id: 'iq_l4', domain: 'logical', difficulty: 3,
      text: 'Nga 100 studentë: 60 studiojnë Matematikë, 50 Fizikë, 30 të dyja. Sa nuk studiojnë asnjërën?',
      options: ['10', '20', '15', '25'],
      correct: '20',
      explanation: 'Bashkim: 60+50−30=80 studiojnë së paku njërën. Jashtë: 100−80=20.',
    },
    ...
    // ── SPATIAL / ABSTRACT (4 q) ─────────────────────────────────────────────
    {
      ...
      options: ['25', '35', '36', '16'],
      correct: '35',
      explanation: 'Të gjithë të tjerët janë katrorë perfektë (2², 3², 4², 5², 6²). 35 nuk është.',
    },
    {
      ...
      correct: 'Kub',
      explanation: 'Trekëndëshi shtrembërohet në 3D si piramidë; katrori shtrembërohet si kub.',
    },
    {
      id: 'iq_s3', domain: 'spatial', difficulty: 2,
      text: 'Nëse vargu ABCD rrotullohet 180°, cili opsion e paraqet saktë rezultatin?',
    ...
    },
    {
      ...
      options: ['I', 'P', 'T', 'A'],
      correct: 'I',
      explanation: 'K(1), A(2), P(3), I(4), T(5), A(6), L(7). Pozicioni 4 = I.',
    },
    {
      id: 'iq_m3', domain: 'memory', difficulty: 2,
      text: 'Vargu ndjek rregullin alternues ×2 dhe −1: 3, 6, 5, 10, 9, 18, __',
      options: ['17', '15', '16', '14'],
      correct: '17',
