...
const SLIDES = [
  {
    ...
    emoji: '🤖',
    tag: 'Udhëzues AI',
    title: 'NeuroAI të drejton drejt ndihmës',
    desc: 'NeuroAI analizon situatën tënde dhe të udhëzon tek eksperti i duhur, artikujt relevantë dhe burimet e duhura.',
    cta: 'Hap NeuroAI',
    href: '/chat',
    from: '#7c3aed',
    to: '#6d28d9',
    ...
    preview: [
      { from: 'user', text: 'Ndihem i/e stresuar në punë...' },
      { from: 'ai',   text: 'Të rekomandoj Dr. Shaqiri — specialist stresi 💼' },
      { from: 'ai',   text: 'Lexo: "Menaxhimi i stresit në vendin e punës" 📖' },
    ],
  },
  {
    id: 'parenting',
